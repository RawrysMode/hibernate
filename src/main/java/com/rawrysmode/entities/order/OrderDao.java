...
public class OrderDao implements Dao<Order> {
    ...
    public List<Order> findAll() {
        return getCurrentSession().createQuery("from Order order by id ASC", Order.class).getResultList();
    }
    ...
    public List<Order> findWhere(String s) {
        return getCurrentSession().createQuery(
                        "from Order o where " +
                                ...
                                "upper(o.route.departureCity.cityName) like :param or " +
                                "upper(o.route.destinationCity.cityName) like :param or " +
